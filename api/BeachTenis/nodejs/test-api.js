...
const testLogin = async () => {
  ...
  const response = await apiRequest('post', '/user/login', loginData);
...
const testRefreshToken = async () => {
  ...
  const response = await apiRequest('post', '/user/refresh-token', { refreshToken });
...
const testLogout = async () => {
  ...
  const response = await apiRequest('post', '/user/logout', null, true);
  
  // Após o logout, o token deve ser invalidado
  const testInvalidToken = await apiRequest('get', '/user', null, true);
